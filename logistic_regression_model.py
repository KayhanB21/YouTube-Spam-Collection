...
class LogisticRegressionModel:
    ...
    def find_best_hyperparameters_avg(self):
        ...
        return self.test_best_model(best_estimator=best_estimator,
                                    ...
                                    confusion_matrix_filename=f'logistic_regression_avg_vector'), best_estimator, best_params
    ...
    def find_best_hyperparameters_avg_tfidf(self):
        ...
        return self.test_best_model(best_estimator=best_estimator,
                                    ...
                                    confusion_matrix_filename=f'logistic_regression_avg_vector_tfidf'), best_estimator, best_params
